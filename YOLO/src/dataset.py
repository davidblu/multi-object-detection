...
class yoloDataset(data.Dataset):
    def __init__(self, root, list_file, train, transform, image_size=448):
        print('data init')
        self.root=root
        self.train = train
    ...
    def __repr__(self):
        return "yoloDataset(train={train}, image_size={size})".format(train=self.train, size=self.image_size)
...
def main():
    ...
    train_dataset = yoloDataset(root=file_root,list_file='voc12_train.txt',train=True,transform = [transforms.ToTensor()] )
